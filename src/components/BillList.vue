...
<template>
  <div class="flex flex-col">
    <div v-if="bills.length === 0" class="py-12 text-center text-slate-400">
      No bills found.
    </div>
    ...
    <div v-else class="flex flex-col">
      <div
        v-for="bill in bills"
        :key="bill.id"
        class="flex items-center justify-between border-b border-slate-100 px-6 py-5 transition last:border-b-0 hover:bg-slate-50 sm:px-8"
      >
        <div class="flex flex-col gap-1">
          ...
          <span class="text-xs" :class="isOverdue(bill) ? 'text-rose-500' : 'text-slate-500'">
            ...
            <span
              ...
              class="ml-2 rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-medium text-slate-600"
            >
              {{ bill.frequency }}
            </span>
          </span>
        ...
        <div class="flex items-center gap-4">
          ...
          <div v-if="!readonly" class="flex items-center gap-1 sm:gap-2">
            <button
